...
### [18-Auth-Login-Registration-Pattern.md](./18-Auth-Login-Registration-Pattern.md) ⭐ NEU
**Was:** Vollständige Login/Registrierungs-Seite mit Supabase Auth  
**Wann:** Benutzer-Authentifizierung, Passwort-Management  
**Enthält:**
- **Login/Signup Tabs:** Tab-basierte UI für An-/Abmeldung
- **Strong Password Detection:** Zod-Schema + Live-Checkliste
- **Passwort vergessen:** E-Mail mit Reset-Link → Neues Passwort
- **Eye Toggle:** Passwort anzeigen/verbergen
- **Error Handling:** Deutsche, nutzerfreundliche Fehlermeldungen
- **E-Mail-Template:** Professionelles HTML für Supabase
...
- [ ] **18-Auth-Login:** Login/Registrierung + Passwort vergessen
