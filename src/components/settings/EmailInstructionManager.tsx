...
import { useEmailInstructions, EmailInstruction } from '@/hooks/useEmailInstructions';
...
export function EmailInstructionManager() {
  const { instructions, isLoading, createInstruction, updateInstruction, deleteInstruction } = useEmailInstructions();
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          E-Mail-Anweisungen verwalten
        </CardTitle>
        <CardDescription>
          Erstellen und bearbeiten Sie Anweisungen für die E-Mail-Generierung durch Pitch Paul.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
          ...
          <div className="space-y-4 pt-4 border-t">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="z.B. Formeller Geschäftsstil"
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="instruction-text">E-Mail-Anweisung *</Label>
              <Textarea
                id="instruction-text"
                value={instruction}
                onChange={(e) => setInstruction(e.target.value)}
                placeholder="Beschreiben Sie, wie die E-Mails geschrieben werden sollen..."
                rows={16}
                className="min-h-[400px]"
              />
              <p className="text-sm text-muted-foreground">
                Diese Anweisung wird an Pitch Paul übergeben und bestimmt, wie die E-Mails formuliert werden sollen.
              </p>
            </div>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Diese Aktion kann nicht rückgängig gemacht werden. Die E-Mail-Anweisung "{name}" wird dauerhaft gelöscht.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
        ...
        {!selectedId && !isCreating && instructions.length === 0 && (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>Keine E-Mail-Anweisungen vorhanden.</p>
