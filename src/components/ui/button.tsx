  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-r from-primary via-highlight to-primary bg-[length:200%_auto] text-white shadow-lg shadow-primary/30 hover:bg-[position:right_center] hover:shadow-xl hover:shadow-primary/40",
        glow: "bg-primary text-primary-foreground shadow-lg shadow-primary/40 hover:shadow-xl hover:shadow-primary/50",
        success: "bg-success text-success-foreground shadow-md shadow-success/20 hover:bg-success/90 hover:shadow-lg hover:shadow-success/30",
        warning: "bg-warning text-warning-foreground shadow-md shadow-warning/20 hover:bg-warning/90 hover:shadow-lg hover:shadow-warning/30",
      },
      size: {
